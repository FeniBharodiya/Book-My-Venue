...
<html lang="en">
  ...
  <head>
    ...
    <title>Vendor Owner Profile</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="VendorOProfile.php" class="logo">Book <em> Venue</em></a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        
                        <ul class="nav">
                            <li><a href="#">Add Vendor</a></li>
                            <li><a href="#">View Vendor's</a></li>
                            <?php
                            if(isset($_SESSION['OName']))
                            {
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="cta-content">
                        ...
                        <h3 class="ODetailrow">PhoneNumber - <?php echo $_SESSION['ONumber'] ?></h3>
                    </div>
                </div>
            </div>
        </div>
