...
<body>
    ...
    <div class="container">
    	...
    	<div class="card">
    		<div class="card-header">Venue Review</div>
    		<div class="card-body">
    			<div class="row">
...
<div id="review_modal" class="modal" tabindex="-1" role="dialog">
  	<div class="modal-dialog" role="document">
    	<div class="modal-content">
            ...
            <form name="frm_feedback" method="POST" action="submit_rating.php">
<!--                <input type="hidden" name="C_ID" id="C_ID" value="<?php session_start(); echo $_SESSION['CID']; ?>"/>-->
