...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../assets/css/SignupCustomer.css">
    </head>
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10">
                        ...
                        <h4 class="font-weight-bold py-3">Sign Up As Customer</h4>
                        <form action="signupCustomerDBC.php"  method="post" onsubmit="return validation()">
                            <div class="form-row">
                                <div class="col-lg-10">
                                    <label>Name</label>
