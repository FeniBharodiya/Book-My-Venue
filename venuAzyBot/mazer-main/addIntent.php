                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered" id="dynamic_field"> 
						<tr>
                            ...
                            <td><input type='button' value= "+" class="btn btn-success" id='addButton'></td>
                    ...
                    <table class="table table-bordered" id="dynamic_response_field"> 
						<tr>
                            ...
                            <td><input type='button' value= "+" class="btn btn-success" id='addResponseButton'></td>
							<!-- <td><button type="button" name="add" id="add" class="btn btn-success">Add More</button></td> -->
						</tr>
					</table>
                    <table class="table table-bordered">
                    ...
                    <input type="button" value="Add" name="btnsubmit" id='getButtonValue' class="btn btn-info">
                    <a href="index.php" class= "btn btn-warning" >Get Intent</a>
                </div>
            </form>
                            <!-- <form class="form">
                                <div class="row">
