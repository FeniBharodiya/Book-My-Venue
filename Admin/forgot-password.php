...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT A_Email FROM admin WHERE A_Email=:email and A_PhoneNumber=:mobile";
    ...
    if ($query->rowCount() > 0) {
        $con = "update admin set A_Password=:newpassword where A_Email=:email and A_PhoneNumber=:mobile";
...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>       
        <title>Online BookVenue System - Forgot Page</title>
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="login.php">
                                        ...
                                        <span class="font-size-xl">BookVenue</span>
                                    </a>
